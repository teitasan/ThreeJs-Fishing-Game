// src/procedural-fisherman/fisherman-model-source.js
import * as THREE from "three";
var HIP_Y = 1.16;
var CHEST_Y = 1.59;
var SHOULDER_Y = 1.95;
var NECK_Y = 1.98;
var HEAD_CENTER_Y = 2.24;
var KNEE_Y = 0.58;
var ANKLE_Y = 0.14;
var ELBOW_Y = 1.52;
var WRIST_Y = 1.13;
...
function addLimbSegmentLocal(parentPivot, length, radiusTop, radiusBottom, lateralDrift, material, name, meta, options) {
  const mesh = addMesh(
    parentPivot,
    name,
...
function createLakesideFishermanPlayerModel(options = {}) {
  ...
  meshes.torso = addMesh(
    chestPivot,
    "JacketTorso",
    new THREE.CylinderGeometry(0.395, 0.3, 0.82, 6),
    mats.jacket,
...
export {
  createLakesideFishermanPlayerModel
};
